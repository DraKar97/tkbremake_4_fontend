...
import { Component, ViewEncapsulation, OnInit, OnDestroy, ViewChildren, AfterViewInit, QueryList, ElementRef, ViewChild } from "@angular/core";
...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  appTitle = "TKB Remake 4";
  appLogo = require("../../assets/tkb.png");
  ...
  hideBar() {
    var e: Element = this.navBar.nativeElement;
    e.setAttribute("style", "height:1px");
    e.setAttribute("aria-expanded", "false");
    e.setAttribute("class", "app-component navbar-collapse menuItemsContainer collapse");
  }
